...
import { B as Button, G as Github } from "../../../chunks/github.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div> <div class="mt-16 space-y-8"><div class="text-center" data-svelte-h="svelte-cm149b"><h2 class="text-3xl font-bold tracking-tight mb-4">Why Choose LLM Link?</h2> <p class="text-lg text-muted-foreground">Unified access to multiple providers with intelligent optimizations</p></div> <div class="grid gap-6 md:grid-cols-3"><div class="text-center space-y-3"><div class="mx-auto flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-primary-foreground">${validate_component(Check, "Check").$$render($$result, { class: "h-6 w-6" }, {}, {})}</div> <h3 class="text-lg font-semibold" data-svelte-h="svelte-rjgtbx">Unified API</h3> <p class="text-sm text-muted-foreground" data-svelte-h="svelte-1ecoo1u">Access all providers through OpenAI, Ollama, or Anthropic API formats</p></div> <div class="text-center space-y-3"><div class="mx-auto flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-primary-foreground">${validate_component(Check, "Check").$$render($$result, { class: "h-6 w-6" }, {}, {})}</div> <h3 class="text-lg font-semibold" data-svelte-h="svelte-1ivnfa5">Smart Detection</h3> <p class="text-sm text-muted-foreground" data-svelte-h="svelte-1hkcnkd">Automatic client detection and format optimization</p></div> <div class="text-center space-y-3"><div class="mx-auto flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-primary-foreground">${validate_component(Check, "Check").$$render($$result, { class: "h-6 w-6" }, {}, {})}</div> <h3 class="text-lg font-semibold" data-svelte-h="svelte-asgxud">Hot Reload</h3> <p class="text-sm text-muted-foreground" data-svelte-h="svelte-lzegxx">Update API keys and switch providers without service restart</p></div></div></div> <div class="mt-12 text-center">${validate_component(Button, "Button").$$render(
    $$result,
    {
      size: "lg",
