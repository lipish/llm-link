...
type LayoutRouteId = RouteId | "/" | "/api" | "/docs" | "/docs/apps/aider" | "/docs/apps/codex" | "/docs/apps/openhands" | "/docs/apps/zed" | "/docs/architecture" | "/docs/protocols" | "/docs/quick-start" | null
